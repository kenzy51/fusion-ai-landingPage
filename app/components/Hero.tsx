      ...
      <div className="relative z-20 w-full max-w-7xl mx-auto px-6 lg:px-20">
        <div className="max-w-3xl">
          ...
          <div className="flex flex-wrap gap-4">
            <a href="https://calendly.com/kanatnazarov/30min" target="_blank">
              <button className="bg-[#d4ff33] text-black px-8 py-4 rounded-full font-bold text-lg hover:shadow-[0_0_30px_rgba(212,255,51,0.3)] transition-all cursor-pointer">
